...
export function ArticleGrid({ articles, showTitle = true, showButton = true }: ArticleGridProps) {
    return (
        <section className="mx-auto max-w-7xl px-6 lg:px-12 py-16 lg:py-24">
            {showTitle && (
                <div className="mb-12">
                    <h2 className="font-serif text-4xl lg:text-5xl text-foreground text-center">Latest Articles</h2>
                </div>
            )}
